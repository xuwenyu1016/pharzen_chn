<?php exit;?>00159012712709855b8bd0c9fb80723eed9bef542324s:4169:"a:2:{s:8:"template";s:4105:"<?php $__Template->display("themes/default/header"); ?>

<img src="assets/image/72.png" class="am-img-responsive am-center" alt="<?php echo $categoryInfo["name"];?>" />

<div class="firm-intro am-padding-top-xl coorperate">
    <div class="am-container">
        ...
        <div class="title-block">
            <p><span>business coorperation</span><span>公司简介</span></p>
        </div>
        ...
        <article>
           <ul class="am-avg-sm-2">
               ...
               <li>
                   <h2>looking forward to coorperate with you</h2>
...
<script type="text/javascript">
    ...
    var map;
    initMap();
</script>";s:12:"compile_time";i:1558591127;}";