<?php exit;?>0015919330488d0393cc1639fd500de3c2147c308090s:10985:"a:2:{s:8:"template";s:10920:"<?php $__Template->display("themes/mobile/header"); ?>
...
<div class="index-construction am-padding-sm">
    <div class="title-block">
        <p><span>epc</span><span>工程总包</span></p>
        <a href="/article/yuanliaoyaoshengchanxianshejiy.html">MORE</a>
    </div>

    <div data-am-widget="slider" class="am-slider am-slider-default" data-am-slider='{"animation":"slide","animationLoop":true,slideshow: false,slideshowSpeed: 15000,"itemWidth":200,"itemMargin":10,minItems: "2",maxItems: "2",controlNav: false}' >
        <ul class="am-slides">
            <?php $listList = service("article","Label","contentList",array( "app"=>"Article", "label"=>"contentList", "class_id"=>2, "sub"=>true, "expand_id"=>3, "limit"=>10, "order"=>"time asc"));  if(is_array($listList)) foreach($listList as $list){ ?>
            <li>
...
<div class="index-system am-padding-horizontal-sm am-padding-vertical-xs">

    <div class="title-block">
        <p><span>system equipment</span><span>系统设备</span></p>
        <a href="/list-xitongshebei.html">MORE</a>
    </div>

    <p class="am-margin-vertical-sm am-text-sm am-padding-horizontal-sm am-padding-vertical-xs">为原料药企业提供成套设备和集成装置的机械设计、三维设计、系统开发与集成，提供定制化、模块化的设计、制造、装配和运行调试服务。</p>

    <ul class="am-avg-sm-3 am-margin-top-sm">
        <li>
            <div>
                <a href="/list-xitongshebei.html">
        ...
        <li>
            <div>
                <a href="/list-xitongshebei.html">
                    <img src="/assets/image/14.png" class=" " alt="机械设备" />
                </a>
            </div>
        </li>
        ...
        <li>
            <div>
                <a href="/list-xitongshebei.html">
                    <img src="/assets/image/18.png" class=" " alt="系统开发与集成" />
                </a>
            </div>
        </li>
        ...
        <li>
            <div>
                <a href="/list-xitongshebei.html">
                    <img src="/assets/image/19.png" class=" " alt="三维设计" />
                </a>
            </div>
        </li>
    </ul>
...
<div class="index-tech am-padding-vertical-sm">
    ...
    <section>
        <article>
            <div>
                <p>为原料药企业提供项目前期论证、概念设计、项目管理、验证工作等技术服务。</p>
                <a href="/list-jishuzixun.html">了解更多</a>
            </div>
        </article>
    </section>
</div>

<div class="index-news am-padding-horizontal-sm am-padding-vertical-xs">

    <div class="title-block">
        <p><span>news</span><span>新闻资讯</span></p>

        <a href="/list-xinwenzixun.html">MORE</a>
    </div>
...
<div class="index-partners am-padding-horizontal-sm">
    ...
    <ul class="am-avg-sm-6 am-margin-top-sm">
...
<div class="index-us am-padding-sm">
    <section>
        <p class="am-text-center">关于我们</p>
    ...
    <a href="/page-gongsijianjie.html">
        <img src="/assets/image/85.png" class="am-img-responsive" alt="法尔森科技" />
    </a>
</div>

<?php $__Template->display("themes/mobile/footer"); ?>
";s:12:"compile_time";i:1560397048;}";